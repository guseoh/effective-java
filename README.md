...
| [아이템 18. 상속보다는 컴포지션을 사용하라](https://github.com/peeljunKim/effective-java/discussions/89)                          | 오지훈 | X     |
...
| [아이템 23. 태그 달린 클래스보다는 클래스 계층구조를 활용하라](https://github.com/peeljunKim/effective-java/discussions/94)               | 김필준 | X     |
