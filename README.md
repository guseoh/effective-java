...
| 아이템                                                                                                              | 담당자 | 질문 여부 |
|:-----------------------------------------------------------------------------------------------------------------|:----|:------|
| [아이템 15. 클래스와 멤버의 접근 권한을 최소화하라](https://github.com/peeljunKim/effective-java/discussions/86)                     | 김필준 |       |
| [아이템 16. public 클래스에서는 public 필드가 아닌 접근자 메서드를 사용하라](https://github.com/peeljunKim/effective-java/discussions/87) | 오지훈 |       |
| [아이템 17. 변경 가능성을 최소화하라](https://github.com/peeljunKim/effective-java/discussions/88)                             | 김필준 |       |
| [아이템 18. 상속보다는 컴포지션을 사용하라](https://github.com/peeljunKim/effective-java/discussions/89)                          | 오지훈 |       |
| [아이템 19. 상속을 고려해 설계하고 문서화하라, 그러지 않았다면 상속을 금지하라](https://github.com/peeljunKim/effective-java/discussions/90)     | 김필준 |       |
| [아이템 20. 추상 클래스보다는 인터페이스를 우선하라](https://github.com/peeljunKim/effective-java/discussions/91)                     | 오지훈 |       |
| [아이템 21. 인터페이스는 구현하는 쪽을 생각해 설계하라](https://github.com/peeljunKim/effective-java/discussions/92)                   | 김필준 |       |
| [아이템 22. 인터페이스는 타입을 정의하는 용도로만 사용하라](https://github.com/peeljunKim/effective-java/discussions/93)                 | 오지훈 |       |
| [아이템 23. 태그 달린 클래스보다는 클래스 계층구조를 활용하라](https://github.com/peeljunKim/effective-java/discussions/94)               | 김필준 |       |
| [아이템 24. 멤버 클래스는 되도록 static으로 만들라](https://github.com/peeljunKim/effective-java/discussions/95)                  | 오지훈 |       |
| [아이템 25. 톱레벨 클래스는 한 파일에 하나만 담으라](https://github.com/peeljunKim/effective-java/discussions/96)                    | 김필준 |       |
...
| 아이템                                                                                            | 담당자 | 질문 여부 |
|:-----------------------------------------------------------------------------------------------|:----|:------|
| [아이템 42. 익명 클래스보다는 람다를 사용하라](https://github.com/peeljunKim/effective-java/discussions/113)     | 오지훈 |       |
| [아이템 43. 람다보다는 메서드 참조를 사용하라](https://github.com/peeljunKim/effective-java/discussions/114)     | 김필준 |       |
| [아이템 44. 표준 함수형 인터페이스를 사용하라](https://github.com/peeljunKim/effective-java/discussions/115)     | 오지훈 |       |
| [아이템 45. 스트림은 주의해서 사용하라](https://github.com/peeljunKim/effective-java/discussions/116)         | 김필준 |       |
| [아이템 46. 스트림에서는 부작용 없는 함수를 사용하라](https://github.com/peeljunKim/effective-java/discussions/117) | 오지훈 |       |
| [아이템 47. 반환 타입으로는 스트림보다 컬렉션이 낫다](https://github.com/peeljunKim/effective-java/discussions/118) | 김필준 |       |
| [아이템 48. 스트림 병렬화는 주의해서 적용하라](https://github.com/peeljunKim/effective-java/discussions/119)     | 오지훈 |       |
